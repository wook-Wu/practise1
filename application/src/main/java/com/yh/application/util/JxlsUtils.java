package com.yh.application.util;
...
//        Date date1 = new Date(1608307200000L);
//        System.out.println(date1);

        SimpleDateFormat simpleDateFormat = new SimpleDateFormat();
        Date parse = simpleDateFormat.parse("2020/03/05 08:30:0");
        System.out.println(parse);


        Date date = DateUtil.parseYYYYMMDDDate("2020/03/05 08:30:0");
        System.out.println(date);
        System.out.println("三月份时间:"+date.getTime()/1000);
